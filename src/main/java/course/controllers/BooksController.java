...
import course.services.BooksService;
...
public class BooksController {
    ...
    @Autowired
    public BooksController(final BooksService booksService, PeopleService peopleService) {
    ...
    public String search(Model model, @RequestParam("title") String title){
        model.addAttribute("books", booksService.findByStartingWith(title));
        return "books/search";
    }
}
